...
const Cards = () => {
  ...
  return (
    ...
    <div class="relative">
        ...
        <input type="text" ref={inputRef} class="block w-full max-w-30 p-4 pl-10 text-sm text-black border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-200 dark:border-gray-300 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Resources..." required/>
