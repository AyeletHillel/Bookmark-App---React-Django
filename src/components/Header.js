...
<section class="bg-white dark:bg-gray-200">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-900">Free Data Sciene and Software Engineering resources to help you advance your skillset</p>
            <button class="max-w-2xl mb-6 bg-[#db2777] hover:bg-pink-700 text-white font-bold py-2 px-4 rounded-full">
Add New Resource
</button>
        </div>
